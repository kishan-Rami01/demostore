...
class Shopay_Store_Slider extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            ...
            'description'                   => __( 'Display posts from selected category as slider.', 'shopay-store' ),
            'customize_selective_refresh'   => true,
        );
        parent::__construct( 'shopay_slider', __( 'MT: Slider', 'shopay-store' ), $widget_ops );
    }
    ...
    private function widget_fields() {
        ...
        if ( shopay_is_active_woocommerce() ) {
            $slider_cat_type_arg = array(
                'default-cat'      => __( 'Default Category', 'shopay-store' ),
                'product-cat'      => __( 'Product Category', 'shopay-store' ),
            );
        } else {
            $slider_cat_type_arg = array(
                'default-cat'      => __( 'Default Category', 'shopay-store' ),
        ...
        $fields = array(
            'featured_products_sec_heading' => array(
                ...
                'shopay_widgets_title'        => __( 'Featured Products Section', 'shopay-store' ),
            ...
            'slider_featured_products_option'   => array(
                ...
                'shopay_widgets_title'          => __( 'Show Featured Products', 'shopay-store' ),
                'shopay_widgets_description'    => __( 'Two latest featured products are listed.', 'shopay-store' ),
            ...
            'featured_sec_title' => array(
                ...
                'shopay_widgets_title'        => __( 'Title', 'shopay-store' ),
                'shopay_widgets_default'      => __( 'Featured Products', 'shopay-store' ),
                'shopay_widgets_field_type'   => 'text'
            ),

            'slider_heading' => array(
                'shopay_widgets_name'         => 'slider_heading',
                'shopay_widgets_title'        => __( 'Slider Section', 'shopay-store' ),
                'shopay_widgets_field_type'   => 'heading'
            ),

            'slider_cat_type' => array(
                'shopay_widgets_name'         => 'slider_cat_type',
                'shopay_widgets_title'        => __( 'Category type', 'shopay-store' ),
                'shopay_widgets_default'      => 'default-cat',
                'shopay_widgets_description'  => __( 'Choose the category type to display on slider.', 'shopay-store' ),
            ...
            'slider_default_cat_slug' => array(
                ...
                'shopay_widgets_title'        => __( 'Default Categories', 'shopay-store' ),
            ...
            'slider_product_cat_slug' => array(
                ...
                'shopay_widgets_title'        => __( 'Product Categories', 'shopay-store' ),
                'shopay_widgets_default'      => '',
            ...
            'slider_post_count' => array(
                ...
                'shopay_widgets_title'        => __( 'Post Count', 'shopay-store' ),
            ...
            'slide_btn_text' => array(
                ...
                'shopay_widgets_title'        => __( 'Slide button text', 'shopay-store' ),
                'shopay_widgets_default'      => __( 'Add to cart', 'shopay-store' ),
                'shopay_widgets_field_type'   => 'text'
            ),
            
            'slider_content_option'   => array(
                'shopay_widgets_name'           => 'slider_content_option',
                'shopay_widgets_title'          => __( 'Show Slider Content', 'shopay-store' ),
                'shopay_widgets_description'    => __( 'Show or hide slider content. Display only post thumbnail', 'shopay-store' ),
                'shopay_widgets_default'        => 'on',
                'shopay_widgets_field_type'     => 'switch'
            ),
            ...
            'slider_featured_heading' => array(
                ...
                'shopay_widgets_title'        => __( 'Featured Section', 'shopay-store' ),
                'shopay_widgets_field_type'   => 'heading'
            ),

            'slider_featured_section_option' => array(
                'shopay_widgets_name'         => 'slider_featured_section_option',
                'shopay_widgets_title'        => __( 'Show Featured Section', 'shopay-store' ),
                'shopay_widgets_description'  => __( 'Checked to show featured section under slider.', 'shopay-store' ),
                'shopay_widgets_default'      => 'on',
                'shopay_widgets_field_type'   => 'switch',
                'shopay_widget_field_relation'  => array(
                    'values' => array(
        ...
        for ( $i = 0; $i <= 1; $i++ ) {
            switch ( $i ) {
                case 1:
                    ...
                    $group_title = __( 'Featured Item 2', 'shopay-store' );
                    break;
                
                default:
                    $field_id = 'featured_image_one';
                    $group_title = __( 'Featured Item 1', 'shopay-store' );
                    break;
            }
    ...
    public function widget( $args, $instance ) {
        ...
        $slider_content_option  = empty( $instance['slider_content_option'] ) ? 'on' : $instance['slider_content_option'];
...
<div class="mt-container">
    ...
    <?php } ?>
        <div class="main-slider-section">
			...
			?>
							<div class="single-slide shopay-bg-image cover-image <?php if ( $slider_content_option === "off" ) echo esc_html( 'no-slider-content' ); ?>" style="background-image:url( <?php echo esc_url( get_the_post_thumbnail_url() ); ?> )">
                                <?php if ( $slider_content_option === "on" ) { ?>
                                ...
                                <?php
                                        ...
                                        echo '<a class="slider-link-tag" href="' .get_the_permalink(). '"></a>';
                                }
                                ?>
							</div><!-- .single-slide -->
			<?php
